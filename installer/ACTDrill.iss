...
Source: "actdrill_Setup-AiTutor_v1.15.0.ps1"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\README.md"; DestDir: "{app}"; Flags: ignoreversion isreadme

[Icons]
Name: "{group}\{#AppName}"; Filename: "{app}\{#AppExe}"
Name: "{group}\Enable AI tutor"; Filename: "pwsh.exe"; Parameters: "-NoProfile -ExecutionPolicy Bypass -File ""{app}\actdrill_Setup-AiTutor_v1.15.0.ps1"""; Comment: "Set up the optional private AI tutor (Ollama)"
Name: "{group}\Uninstall {#AppName}"; Filename: "{uninstallexe}"
Name: "{autodesktop}\{#AppName}"; Filename: "{app}\{#AppExe}"; Tasks: desktopicon

[Run]
; if the user opted in, run the AI setup helper (visible window) after install
Filename: "pwsh.exe"; Parameters: "-NoProfile -ExecutionPolicy Bypass -File ""{app}\actdrill_Setup-AiTutor_v1.15.0.ps1"""; Description: "Set up the AI tutor"; Flags: postinstall skipifsilent; Tasks: aitutor
